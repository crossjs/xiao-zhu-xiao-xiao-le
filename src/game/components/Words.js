...
(function (game) {
    var Words = /** @class */ (function (_super) {
        ...
        function Words() {
            ...
            _this.combo = -1;
            _this.threshold = 2;
            _this.words = ["good", "great", "amazing", "excellent"];
            _this.sounds = [
                game.GoodSound,
                game.GreatSound,
                game.AmazingSound,
        ...
        Words.prototype.destroy = function () {
            this.hide();
        };
        Words.prototype.createView = function (fromChildrenCreated) {
        ...
        Words.prototype.update = function (combo) {
            if (combo === this.combo) {
                return;
            }
        ...
        Words.prototype.show = function (index) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, yyw.zoomIn(this.main, 300, egret.Ease.elasticOut)];
                        case 2:
                            _a.sent();
        ...
        Words.prototype.hide = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, yyw.zoomOut(this.main)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
