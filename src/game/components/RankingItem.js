...
(function (game) {
    var RankingItem = /** @class */ (function (_super) {
        ...
        RankingItem.prototype.setData = function (data) {
            return __awaiter(this, void 0, void 0, function () {
                var key, avatarUrl, nickName, score, avatar;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            yyw.eachChild(this, function (child) {
                                child.visible = !!data;
                            });
                            if (!data) return [3 /*break*/, 2];
                            key = data.key, avatarUrl = data.avatarUrl, nickName = data.nickName, score = data.score;
                            if (key < 4) {
                            ...
                            return [4 /*yield*/, yyw.loadImage(avatarUrl)];
                        case 1:
                            avatar = _a.sent();
