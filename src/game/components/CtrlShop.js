...
var game;
(function (game) {
    var CtrlShop = /** @class */ (function (_super) {
        __extends(CtrlShop, _super);
        function CtrlShop() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.coins = 0;
            return _this;
        }
        CtrlShop.prototype.createView = function (fromChildrenCreated) {
            return __awaiter(this, void 0, void 0, function () {
                var _this = this;
                return __generator(this, function (_a) {
                    _super.prototype.createView.call(this, fromChildrenCreated);
                    if (fromChildrenCreated) {
                        yyw.onTap(this.main, function () {
                            yyw.director.toScene("shop", true);
                        });
                        yyw.on("COINS_GOT", function (_a) {
                            var amount = _a.data.amount;
                            _this.updateCoins(amount);
                        });
        ...
        CtrlShop.prototype.updateCoins = function (mutation) {
            return __awaiter(this, void 0, void 0, function () {
                var coins, error_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
