...
var game;
(function (game) {
    var CtrlGroup2 = /** @class */ (function (_super) {
        __extends(CtrlGroup2, _super);
        function CtrlGroup2() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        CtrlGroup2.prototype.createView = function (fromChildrenCreated) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    if (fromChildrenCreated) {
                        ...
                        // 每日签到
                        yyw.onTap(this.btnCheckin, function () {
                            yyw.director.toScene("checkin", true);
                        });
                        // 排行榜
                        yyw.onTap(this.btnBoard, function () {
