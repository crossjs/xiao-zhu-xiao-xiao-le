...
(function (game) {
    var Closest = /** @class */ (function (_super) {
        ...
        Closest.prototype.initialize = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    // 此时界面上存在两个开放域，
                    // 为避免冲突，应将 closest 移除
                    yyw.on("SCENE_ENTERING", function (_a) {
                        var name = _a.data.name;
                        if (name === "reviving" || name === "ranking") {
                            _this.removeBmp();
                        }
                    });
                    yyw.on("SCENE_ESCAPED", function (_a) {
                        var name = _a.data.name;
                        if (name === "reviving" || name === "ranking") {
                            egret.setTimeout(_this.createBmp, _this, 500);
                        }
                    });
                    return [2 /*return*/];
                });
        ...
        Closest.prototype.destroy = function () {
            this.removeBmp();
        };
        Closest.prototype.createView = function (fromChildrenCreated) {
            return __awaiter(this, void 0, void 0, function () {
                var _this = this;
                return __generator(this, function (_a) {
         ...
         * 显示分数接近的好友，通过开放数据域
         */
        Closest.prototype.update = function (score) {
            if (!this.bmpClosest) {
                return;
            }
            // 主域向子域发送自定义消息
