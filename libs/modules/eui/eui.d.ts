...
declare namespace eui {
  ...
  class DefaultAssetAdapter implements IAssetAdapter {
    ...
    getAsset(
      source: string,
      callBack: (data: any, source: string) => void,
      thisObject: any
    ): void;
    /**
     * @private
...
declare namespace eui.sys {
  ...
  class Animation {
     ...
     */
    constructor(
      updateFunction: (animation: Animation) => void,
      thisObject: any
    );
    /**
     * @private
...
declare namespace eui {
   ...
   * @language zh_CN
   */
  class EditableText extends egret.TextField
    implements UIComponent, IDisplayText {
    /**
     * Constructor.
     * @version Egret 2.4
     * @version eui 1.0
...
declare namespace eui {
   ...
   * @language zh_CN
   */
  class BitmapLabel extends egret.BitmapText
    implements UIComponent, IDisplayText {
    constructor(text?: string);
    /**
     * @private
