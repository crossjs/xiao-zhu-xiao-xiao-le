...
declare namespace egret_native {
  ...
  function nrDownloadBuffers(
    callback: (displayCmdBuffer: Float32Array) => void
  ): void;
  function nrSetRenderMode(mode: number): void;
  function nrRenderDisplayObject(
    id: number,
    scale: number,
    useClip: boolean,
    clipX: number,
  ...
  function nrRenderDisplayObject2(
    id: number,
    offsetX: number,
    offsetY: number,
    forHitTest: boolean
  ...
  function nrSetCanvasScaleFactor(
    factor: number,
    scalex: number,
    scaley: number
  ): void;
...
declare namespace egret {
  interface Geolocation {
    addEventListener<Z>(
      type: "ioError",
      listener: (this: Z, e: GeolocationEvent) => void,
      thisObject: Z,
      useCapture?: boolean,
      priority?: number
    ): any;
...
declare namespace egret {
  ...
  class HTTPStatusEvent extends Event {
     ...
     * @language zh_CN
     */
    static dispatchHTTPStatusEvent(
      target: IEventDispatcher,
      status: number
    ): boolean;
  }
...
declare namespace egret {
  interface HttpRequest {
    addEventListener<Z>(
      type: "ioError",
      listener: (this: Z, e: IOErrorEvent) => void,
      thisObject: Z,
      useCapture?: boolean,
      priority?: number
    ): any;
...
declare namespace egret {
  interface HttpRequest {
    addEventListener<Z>(
      type: "progress",
      listener: (this: Z, e: ProgressEvent) => void,
      thisObject: Z,
      useCapture?: boolean,
      priority?: number
    ): any;
...
declare namespace egret {
  interface Stage {
    addEventListener<Z>(
      ...
      listener: (this: Z, e: StageOrientationEvent) => void,
      thisObject: Z,
      useCapture?: boolean,
      priority?: number
    ): any;
  ...
  class StageOrientationEvent extends Event {
     ...
     * @language zh_CN
     */
    static dispatchStageOrientationEvent(
      target: IEventDispatcher,
      type: string
    ): boolean;
  }
...
declare namespace egret {
  interface Timer {
    addEventListener<Z>(
      type: "timer" | "timerComplete",
      listener: (this: Z, e: TimerEvent) => void,
      thisObject: Z,
      useCapture?: boolean,
      priority?: number
    ): any;
...
declare namespace egret.sys {
  ...
  class BitmapNode extends RenderNode {
     ...
     */
    cleanBeforeRender(): void;
    static $updateTextureData(
      node: sys.NormalBitmapNode,
      image: BitmapData,
      bitmapX: number,
      bitmapY: number,
      bitmapWidth: number,
...
declare namespace egret {
  ...
  interface TextField {
    addEventListener<Z>(
      type: "link",
      listener: (this: Z, e: TextEvent) => void,
      thisObject: Z,
      useCapture?: boolean,
      priority?: number
    ): any;
    addEventListener<Z>(
      ...
      listener: (this: Z, e: FocusEvent) => void,
      thisObject: Z,
      useCapture?: boolean,
      priority?: number
    ): any;
