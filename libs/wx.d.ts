...
declare namespace wx {
  ...
  function onWindowResize(
    callback: (res: { windowWidth: number; windowHeight: number }) => void
  ): void;
  /**
   * 取消监听窗口尺寸变化事件
   */
  ...
  function getStorageInfo(object: {
    success?: (
      res: { keys: Array<string>; currentSize: number; limitSize: number }
    ) => void;
    fail?: (res?: any) => void;
    complete?: (res?: any) => void;
  }): void;
  ...
  interface InnerAudioContext {
     ...
     */
    onError(
      callback: (res: { errCode: 10001 | 10002 | 10003 | 10004 | -1 }) => void
    ): void;
    /**
     * 取消监听音频暂停事件
     */
  ...
  function onCompassChange(
    callback: (res: { direction: number; accuracy: number | string }) => void
  ): void;
