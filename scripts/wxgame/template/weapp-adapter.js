(function(modules) {
  ...
  [
    function(module, exports, __webpack_require__) {
      ...
      function inject() {
        _window.addEventListener = _window.canvas.addEventListener = function(
          type,
          listener
        ) {
          _window.document.addEventListener(type, listener);
        };
        _window.removeEventListener = _window.canvas.removeEventListener = function(
          type,
          listener
        ) {
        ...
        if (
          ...
          for (var _key in _window.document) {
            var _descriptor = Object.getOwnPropertyDescriptor(
              global.document,
              _key
            );
    ...
    function(module, exports, __webpack_require__) {
      ...
      var HTMLImageElement = (exports.HTMLImageElement = (function(
        _HTMLElement
      ) {
        ...
        function HTMLImageElement() {
          ...
          return _possibleConstructorReturn(
            this,
            (
              HTMLImageElement.__proto__ ||
              Object.getPrototypeOf(HTMLImageElement)
            ).call(this, "img")
          );
        }
        ...
        function HTMLCanvasElement() {
          ...
          return _possibleConstructorReturn(
            ...
            (
              ...
              Object.getPrototypeOf(HTMLCanvasElement)
            ).call(this, "canvas")
          );
        }
      ...
      var HTMLElement = (function(_Element) {
        ...
        function HTMLElement() {
          ...
          var _this = _possibleConstructorReturn(
            this,
            (HTMLElement.__proto__ || Object.getPrototypeOf(HTMLElement)).call(
              this
            )
          );
        ...
        _createClass(HTMLElement, [
          ...
          },
          {
            ...
            get: function get() {
              var ret =
                parseInt(this.style.fontSize, 10) * this.innerHTML.length;
      ...
      var HTMLAudioElement = (function(_HTMLMediaElement) {
        ...
        function HTMLAudioElement() {
          ...
          return _possibleConstructorReturn(
            this,
            (
              HTMLAudioElement.__proto__ ||
              Object.getPrototypeOf(HTMLAudioElement)
            ).call(this, "audio")
          );
        }
      ...
      var HTMLMediaElement = (function(_HTMLElement) {
        ...
        function HTMLMediaElement(type) {
          ...
          return _possibleConstructorReturn(
            this,
            (
              HTMLMediaElement.__proto__ ||
              Object.getPrototypeOf(HTMLMediaElement)
            ).call(this, type)
          );
        }
      ...
      var WebSocket = (function() {
        ...
        function WebSocket(url) {
          ...
          if (typeof url !== "string" || !/(^ws:\/\/)|(^wss:\/\/)/.test(url)) {
            throw new TypeError(
              "Failed to construct 'WebSocket': The URL '" +
                url +
                "' is invalid"
            );
          }
