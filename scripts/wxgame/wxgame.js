...
var WxgamePlugin = /** @class */ (function () {
    ...
    WxgamePlugin.prototype.onFinish = function (pluginContext) {
        return __awaiter(this, void 0, void 0, function () {
            var gameJSPath, gameJSContent, projectConfig, optionStr, reg, replaceStr, orientation, gameJSONPath, gameJSONContent, odcTplPath, odcTgtPath;
            return __generator(this, function (_a) {
                ...
                odcTplPath = path.join(pluginContext.projectRoot, "openDataContext");
                odcTgtPath = path.join(pluginContext.outputDir, "openDataContext");
